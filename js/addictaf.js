$(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://api.addictaf.com/posts/post/?category=ADDICTAF&limit=50&'+$queryParams,
    ...
    $.ajax({
        type: 'GET',
        url: 'https://api.addictaf.com/posts/post/?category=ADDICTAF&is_video=1&limit=50&'+$queryParams,
        success: function (data) {
            $.each(data.results, function (i, post) {
                post.address = liveUrl + '/post/?id='+post.id;
